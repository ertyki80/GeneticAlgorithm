...
namespace GeneticAlgorithm.Implementations.ChromosomeService
{
    ...
    public abstract class CrossoverBase : ICrossover
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossoverBase"/> class.
        /// </summary>
        ...
        public IList<IChromosome> Cross(IList<IChromosome> parents)
        {
            ...
            {
                throw new CrossoverException($"A chromosome should have, at least, {MinChromosomeLength} genes. {firstParent.GetType().Name} has only {firstParent.Length} gene.");
            }
