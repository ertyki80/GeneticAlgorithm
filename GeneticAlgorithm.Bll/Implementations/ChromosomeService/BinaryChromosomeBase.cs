...
namespace GeneticAlgorithm.Implementations.ChromosomeService
{
    ...
    public abstract class BinaryChromosomeBase : ChromosomeBase, IBinaryChromosome
    {
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="BinaryChromosomeBase"/>.
        /// </summary>
        /// <returns>A <see cref="System.String"/> that represents the current <see cref="BinaryChromosomeBase"/>.</returns>
